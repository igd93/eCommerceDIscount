...
INSERT INTO Beer (ProductName, PricePerUnit, IsPack, InventoryId)
...
INSERT INTO Vegetable (ProductName, PricePer100g, InventoryId)
...
INSERT INTO Bread (ProductName, PricePerUnit, Age, InventoryId)
...
INSERT INTO VegetableDiscount (MinGrams, MaxGrams, DiscountPercentage)
VALUES  (0, 100, 0.05),
        (101, 500, 0.07),
        (501, 9999, 0.1);
